...
def main() -> None:
    ...
    # Extract experiment number from run_dir path
    # e.g., data/output/011/1/20241224/001_convnextv2_base -> exp_num = "011"
    run_dir_parts = run_dir.parts
    try:
        output_idx = run_dir_parts.index("output")
        exp_num = run_dir_parts[output_idx + 1]
    except (ValueError, IndexError):
        exp_num = "unknown"

    model_name = run_dir.name
    output_dir = data_dir / "output" / "pdf" / exp_num / model_name
